    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Administartors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Administartors_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchasedSubscriptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PurchasedSubscriptions_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PurchasedSubscriptions_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PurchasedSubscriptions_Subscriptions_SubscriptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchasedSubscriptions_ClientId",
                table: "PurchasedSubscriptions",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchasedSubscriptions_GroupId",
                table: "PurchasedSubscriptions",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchasedSubscriptions_SubscriptionId",
                table: "PurchasedSubscriptions",
